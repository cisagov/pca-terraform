...
issue](https://github.com/cisagov/pca-terraform/issues) in this
...
request](https://github.com/cisagov/pca-terraform/pulls), you will
...
```bash
cd pca-terraform
pyenv virtualenv <python_version_to_use> pca-terraform
pyenv local pca-terraform
