...
SSM_KEY_GOPHISH_VNC_PASSWORD = "${ssm_key_gophish_vnc_password}"  # nosec
SSM_KEY_GOPHISH_VNC_USER = "${ssm_key_gophish_vnc_user}"
SSM_KEY_GOPHISH_VNC_USER_PRIVATE_SSH_KEY = "${ssm_key_gophish_vnc_user_private_ssh_key}"
...
for ssm_key, param_name in (
    ...
    (SSM_KEY_GOPHISH_VNC_USER_PRIVATE_SSH_KEY, "vnc_user_private_ssh_key"),
):
